    ...
    // iframe打开tab
 	$(document).on('click', '.js-create-tab', function(){
 	    parent.$(parent.document).data('multitabs').create({
 	        ...
 	        url : $(this).data('url') ? $(this).data('url') : 'toHt/toHTmain'
 	    }, true);
 	});
