    ...
    d.extend(l.prototype, {
        action: function (a, b) {
            ...
            var c = this._nodeToButton(a), e = this.c.dom.collection.buttonLiner,
                ...
                g = this.s.dt, h = d(c.node), f = function (a) {
            ...
            for (var g =
                ...
                if (j) if (d.isArray(j)) this._expandButton(a, j, c, e); else {
                    ...
                    if (p) {
                        ...
                        h++
                                   ...
                                   b) {
            var c = this.c.dom.button, e = this.c.dom.buttonLiner, g = this.c.dom.collection, h = this.s.dt,
                f = function (b) {
            ...
            // console.log(this.s.dt.settings()[0])
            // console.log(this.s.dt.settings()[0].oInit.buttons[0].iTname)
            var q = function (a, b, c, e) {
                    e.action.call(b.button(c), a, b, c, e);
                    d(b.table().node()).triggerHandler("buttons-action.dt", [b.button(c), b, c, e])
                }, g = a.tag || c.tag,
                j = d("<" + g + "/>").addClass(c.className).attr("data-bs-toggle", "modal").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls",
            ...
            // console.log(a)
            e.tag ? (g = d("<" + e.tag + "/>").html(f(a.text)).addClass(e.className), "a" === e.tag.toLowerCase() && g.attr("href", "#"), j.append(g)) : j.html(f(a.text)),j.attr("data-bs-target", a.iTname);
            ...
            if (!b._buttonsHandled) {
                var c = function (e) {
                    for (var g = 0, h = e.length; g < h; g++) {
                        var f = e[g].conf, q = e[g].node;
                        if (f.key) if (f.key === a) b._buttonsHandled = !0, d(q).click(); else if (d.isPlainObject(f.key) && f.key.key === a && (!f.key.shiftKey || b.shiftKey)) if (!f.key.altKey || b.altKey) if (!f.key.ctrlKey ||
                            b.ctrlKey) if (!f.key.metaKey || b.metaKey) b._buttonsHandled = !0, d(q).click();
    ...
    d.extend(k, {
        collection: {
            ...
            action: function (a, b, c, e) {
                var g = d(c).parents("div.dt-button-collection"), a = c.position(), h = d(b.table().container()),
                    f = !1, i = c;
