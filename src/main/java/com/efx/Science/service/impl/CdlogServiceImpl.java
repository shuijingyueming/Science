...
import com.efx.Science.dao.cdlogMapper;
import com.efx.Science.model.PageBean;
import com.efx.Science.model.cdlog;
import com.efx.Science.model.cdlogExample;
import com.efx.Science.model.cdlogExample.Criteria;
import com.efx.Science.service.CdlogService;
...
public class CdlogServiceImpl implements CdlogService {
    ...
    public PageBean selectPageBean(PageBean pb) throws ParseException {
        ...
        if(pb.getOthersql()!=null)c.andLog003GreaterThanOrEqualTo(sdf.parse(pb.getOthersql()+" 00:00:00"));
        if(pb.getOthersql1()!=null)c.andLog003LessThanOrEqualTo(sdf.parse(pb.getOthersql1()+" 23:59:59"));
    ...
    @Override
    public void deletePageBean(PageBean pb) throws ParseException {
        cdlogExample e1 = new cdlogExample();
        Criteria c = e1.createCriteria();
        if(pb.getOthersql()!=null)c.andLog003GreaterThanOrEqualTo(sdf.parse(pb.getOthersql()+" 00:00:00"));
        if(pb.getOthersql1()!=null)c.andLog003LessThanOrEqualTo(sdf.parse(pb.getOthersql1()+" 23:59:59"));
